...
use crate::logic::locker::Item;
use crate::utils::shuffle::shuffle;
use crate::utils::to_number;
    ...
    loop {
        match scene {
            ...
            Scene::Peeping => {
                ...
                match request_result {
                    true => {
                        ...
                        println!("Agent {} left the room.", agent_id);
                        println!()
                    }
                    _ => {}
                }
            ...
            Scene::Predicting => {
                ...
                println!("You should predict the position of the box the user will go to retrieve their item.");
